#
# Be sure to run `pod lib lint ZLTTTAttributedLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ZLTTTAttributedLabel'
  s.version          = '0.3.0'
  s.summary          = 'A short description of ZLTTTAttributedLabel.'
